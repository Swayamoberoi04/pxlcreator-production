        ...
        <Container className="relative z-10 -mt-4 pb-14 sm:pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 xl:gap-16 items-start">
            ...
            <CinematicReveal variant="rise" delay={0.12}>
              <div className="depth-card flex flex-col gap-6 lg:sticky lg:top-24 rounded-2xl border border-border/60 bg-surface/60 backdrop-blur-sm p-6 shadow-[0_0_60px_rgba(255,215,0,0.05)]">
...
function StarIcon({ filled }: { filled: boolean }) {
  return (
    <svg width="14" height="14" viewBox="0 0 24 24" fill={filled ? "#ffd700" : "none"} stroke={filled ? "none" : "#444"} strokeWidth="1.5" aria-hidden="true">
