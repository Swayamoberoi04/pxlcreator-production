  ...
  try {
    ...
    if (new Date(dt.expires_at) < new Date()) {
      return htmlError(
        ...
        "Please contact support at support@pxlcreator.com for a new link.",
        410
      )
    }
    ...
    if (dt.download_count >= dt.max_downloads) {
      return htmlError(
        ...
        "Contact support@pxlcreator.com to request a new link.",
        429
      )
    }
      ...
      if (orderItem) {
        ...
        if (order?.status !== "paid") {
          return htmlError(
            ...
            "If you believe this is an error, contact support@pxlcreator.com.",
            402
          )
        }
      }
...
<head>
  ...
  <style>
    *{box-sizing:border-box;margin:0;padding:0}
    ...
    h1{font-size:1.25rem;font-weight:700;color:#ffd700;margin-bottom:0.75rem}
