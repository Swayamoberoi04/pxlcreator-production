...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    a: "Download links are valid for 30 days from purchase and allow up to 5 downloads. If your link expires, contact us at support@pxlcreator.com and we'll reissue it — no questions asked.",
  },
  ...
  /* ── Returns & Refunds ── */
  {
    ...
    a: "Yes. We offer a 30-day money-back guarantee on all purchases. If you're not satisfied for any reason, email support@pxlcreator.com with your order number and we'll process a full refund.",
  },
  {
    category: "Returns & Refunds",
