    ...
    <div className="relative w-full bg-background overflow-hidden min-h-[80vh] flex items-center justify-center px-4">
      ...
      <Container size="narrow" className="relative z-10 py-16 text-center">
        ...
        <CinematicReveal variant="depth">
          <div className="flex justify-center mb-8">
            <div className="relative flex h-24 w-24 items-center justify-center">
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gold/15 border border-gold/30 shadow-[0_0_40px_rgba(255,215,0,0.20)]">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#ffd700" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <CinematicReveal variant="depth" delay={0.08}>
          ...
          <p className="text-[1rem] text-muted/70 leading-relaxed mb-2">
            Your <strong className="text-foreground">{planName} {cycleLabel}</strong> plan is now active.
          </p>
          {untilLabel && (
            <p className="text-[0.875rem] text-muted/55 mb-10">
              Access valid until{" "}
        ...
        <CinematicReveal variant="rise" delay={0.16}>
          <div className="depth-card rounded-2xl border border-gold/20 bg-surface/70 backdrop-blur-sm p-6 text-left mb-10 max-w-md mx-auto shadow-[0_0_60px_rgba(255,215,0,0.06)]">
            ...
            <ul className="flex flex-col gap-2.5">
              {unlocked.map((item) => (
                <li key={item} className="flex items-center gap-2.5">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ffd700" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                    <polyline points="20 6 9 17 4 12"/>
                  </svg>
        ...
        <CinematicReveal variant="rise" delay={0.24}>
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/presets"
              className="inline-flex items-center gap-2 rounded-xl bg-gold px-7 py-3.5 text-sm font-semibold text-background hover:bg-gold-dim transition-colors shadow-[0_0_24px_rgba(255,215,0,0.20)]"
            >
          ...
          <p className="mt-8 text-[0.8125rem] text-muted/45">
