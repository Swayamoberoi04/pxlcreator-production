    ...
    <div className="relative w-full bg-background overflow-hidden min-h-[80vh] flex items-center justify-center px-4">
      ...
      <Container size="narrow" className="relative z-10 py-16 text-center">
        ...
        <CinematicReveal variant="depth">
          <div className="flex justify-center mb-8">
            <div className="relative flex h-24 w-24 items-center justify-center">
              ...
              <div className="relative flex h-20 w-20 items-center justify-center rounded-full bg-gold/15 border border-gold/30 shadow-[0_0_40px_rgba(201,168,76,0.20)]">
                <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#C9A84C" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
        ...
        <CinematicReveal variant="rise" delay={0.16}>
          <div className="depth-card rounded-2xl border border-gold/20 bg-surface/70 backdrop-blur-sm p-6 text-left mb-10 max-w-md mx-auto shadow-[0_0_60px_rgba(201,168,76,0.06)]">
        ...
        <CinematicReveal variant="rise" delay={0.24}>
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/presets"
              className="inline-flex items-center gap-2 rounded-xl bg-gold px-7 py-3.5 text-sm font-semibold text-background hover:bg-gold-dim transition-colors shadow-[0_0_24px_rgba(201,168,76,0.20)]"
            >
