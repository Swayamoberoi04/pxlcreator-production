          ...
          <div className="flex flex-col items-center gap-6 max-w-2xl mx-auto">
            ...
            <CinematicReveal variant="rise" delay={0.2}>
              <div className="flex flex-wrap items-center justify-center gap-3 mt-2">
                <a
                  href="#plans"
                  className="inline-flex items-center gap-2 rounded-xl bg-gold px-7 py-3.5 text-base font-semibold text-background hover:bg-gold-dim transition-colors shadow-[0_0_40px_rgba(255,215,0,0.22)]"
                >
                  View Plans
                </a>
                <Link
        ...
        <Container className="relative z-10 text-center">
          <CinematicReveal variant="depth">
            <div className="flex flex-col items-center gap-6 max-w-xl mx-auto">
              ...
              <a
                href="#plans"
                className="inline-flex items-center gap-2 rounded-xl bg-gold px-8 py-4 text-base font-semibold text-background hover:bg-gold-dim transition-colors shadow-[0_0_48px_rgba(255,215,0,0.28)]"
              >
                Get Premium Access
              </a>
  ...
  return (
    <div
      className={cn(
        ...
        plan.featured
          ? "border-gold/40 bg-surface shadow-[0_0_80px_rgba(255,215,0,0.08)] md:scale-[1.02]"
          ...
          className={cn(
            ...
            isCurrentPlan
              ...
              : disabled
                ...
                : plan.featured
                  ? "bg-gold text-background hover:bg-gold-dim active:scale-[0.98] shadow-[0_0_24px_rgba(255,215,0,0.20)]"
