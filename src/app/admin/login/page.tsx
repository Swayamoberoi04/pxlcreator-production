    ...
    <div className="flex-1 flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="relative w-full max-w-[380px]">
        ...
        <div className="flex flex-col items-center gap-3 mb-8">
          <div className="h-14 w-14 rounded-2xl bg-gold/10 border border-gold/25 flex items-center justify-center shadow-[0_0_40px_rgba(255,215,0,0.12)]">
        ...
        {/* Glassmorphism card */}
        <div className="relative rounded-2xl border border-white/[0.09] bg-white/[0.03] backdrop-blur-xl p-6 shadow-[0_24px_80px_rgba(0,0,0,0.5),0_0_0_1px_rgba(255,215,0,0.04)]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button
              ...
              className="rounded-xl bg-gold text-[#080808] font-bold py-3.5 text-[0.9375rem] tracking-wide transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed hover:bg-gold-dim active:scale-[0.97] shadow-[0_4px_20px_rgba(255,215,0,0.20)]"
            >
