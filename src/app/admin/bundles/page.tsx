  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-[0.8125rem] text-muted/40 mt-0.5">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          >
            ...
            <p className="text-[0.72rem] text-muted/35 mt-1 tracking-wide uppercase">{label}</p>
          </div>
        ))}
      </div>
      ...
      <div className="rounded-xl border border-border/50 bg-surface overflow-hidden">
        ...
        <div className="px-5 py-4 border-b border-border/40 flex items-center justify-between">
          <h2 className="text-[0.875rem] font-bold text-foreground/80">All Bundles</h2>
        ...
        {loading && (
          <div className="px-5 py-12 text-center">
            <p className="text-muted/30 text-sm">Loading bundles…</p>
          </div>
        )}
        {!loading && error && (
          <div className="px-5 py-12 text-center">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[0.75rem] text-muted/35 truncate mt-0.5">
                        {bundle.tagline}
                      </p>
                    </div>
                    ...
                    <div className="w-[80px] flex-shrink-0 text-center hidden sm:block">
                      <p className="text-[0.9rem] font-bold text-foreground/80">{totalCount}</p>
                      <p className="text-[0.6rem] text-muted/30 uppercase tracking-wide">presets</p>
                    </div>

                    {/* Pricing */}
                    <div className="w-[120px] flex-shrink-0 text-right hidden md:block">
                      <p className="text-[0.9rem] font-bold text-gold">${bundle.price}</p>
                      <p className="text-[0.7rem] text-muted/30 line-through">${bundle.individualValueUsd}</p>
                    </div>
                    ...
                    <div className="flex-shrink-0 flex items-center gap-2">
                      <Link
                        ...
                        target="_blank"
                        className="text-[0.75rem] font-medium text-muted/40 hover:text-muted/70 transition-colors px-2 py-1 rounded"
        ...
        {!loading && !error && bundles.length === 0 && (
          <div className="px-5 py-14 text-center">
            <p className="text-muted/30 text-sm">No bundles found.</p>
            <p className="text-muted/20 text-xs mt-1">
      ...
      <div className="rounded-xl border border-border/40 bg-surface-2/30 px-5 py-4">
        <p className="text-[0.8125rem] font-semibold text-foreground/60 mb-1">
          Bundle management
        </p>
        <p className="text-[0.775rem] text-muted/35 leading-relaxed">
