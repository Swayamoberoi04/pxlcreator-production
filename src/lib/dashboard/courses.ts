...
const lightroomMasteryCourse: Course = {
  ...
  modules: [
    ...
    },
    {
      ...
      lessons: [
        { id: "lr-l16", title: "Export Settings: Understanding Every Option",   description: "JPEG vs. TIFF vs. DNG. sRGB vs. AdobeRGB vs. ProPhoto. What does 'Long Edge: 2048' mean in practice? Understand every export setting and know exactly which combination to use for social media, print, client delivery, and portfolio display.", duration: "16 min", type: "video",    free: false, skillsGained: ["Export workflow", "Format understanding"] },
  ...
  modules: [
    {
      ...
      lessons: [
        { id: "cg-l1",  title: "Colour Space, Gamma, and Why It Matters",       description: "Why does log footage look flat? What is a colour space and why does your footage need to be in the right one before grading? Understand REC.709, REC.2020, DCI-P3, and how your camera's log format maps to each.", duration: "22 min", type: "video",    free: true,  skillsGained: ["Colour space fundamentals", "Log footage understanding"] },
        { id: "cg-l2",  title: "The Scopes: Reading Waveform, Parade, and Vectorscope", description: "Learn to read the professional scopes that every colorist uses instead of relying on monitor calibration alone. Waveform for exposure, Parade for channel balance, Vectorscope for saturation and hue accuracy. Grade by data, not by eye alone.", duration: "20 min", type: "video",    free: false, skillsGained: ["Scope reading", "Technical colour analysis"] },
        { id: "cg-l3",  title: "LUTs: Technical vs. Creative",                  description: "Technical LUTs (Input/Output Transforms) convert between colour spaces. Creative LUTs are looks applied on top. Understand the difference and why applying a creative LUT to log footage without a technical LUT first destroys your image.", duration: "18 min", type: "video",    free: false, skillsGained: ["LUT pipeline", "Technical vs. creative LUT"] },
        { id: "cg-l4",  title: "The Node Tree: Resolve's Superpower",           description: "Resolve's node-based workflow lets you separate correction layers logically: Node 1 (Input Transform), Node 2 (Primary Correction), Node 3 (Creative Grade), Node 4 (Secondary Corrections). Learn to build and label a template node tree you'll use on every project.", duration: "25 min", type: "video",    free: false, skillsGained: ["Node-based workflow", "Resolve structure"] },
    ...
    },
    {
      ...
      lessons: [
        { id: "cg-l6",  title: "The Teal-Orange Look: What It Is and Isn't",   description: "The most misunderstood look in cinema. Teal-orange is not an Instagram filter — it's a deliberate exploitation of complementary colours using skin tone warmth vs. shadow desaturation. Learn to build a teal-orange grade that looks cinematic, not processed.", duration: "28 min", type: "video",    free: false, skillsGained: ["Teal-orange technique", "Complementary colour grading"] },
        { id: "cg-l7",  title: "Warm Commercial Grade (Advertising Look)",      description: "The look used in Apple, Nike, and high-end brand advertising: lifted shadows, clean highlights, warm midtones, skin-accurate colour, zero crushing. The grade says: 'Everything is beautiful and aspirational.' Build it from scratch using only Resolve wheels and curves.", duration: "24 min", type: "video",    free: false, skillsGained: ["Commercial colour grading", "Advertising look"] },
        { id: "cg-l8",  title: "Moody Dark Narrative Grade",                   description: "The look of prestige drama: deep shadows with visible shadow detail, desaturated highlights, pushed split-toning (cool shadows / warm highlights or vice versa), film grain at a visible level. Build the complete look for a dialogue scene.", duration: "30 min", type: "video",    free: false, skillsGained: ["Dark narrative grade", "Split-toning mastery"] },
        { id: "cg-l9",  title: "Documentary Warm Grade",                        description: "National Geographic, Vice, and travel documentary look: warm, high-saturation midtones, natural shadow colour, sky that pops without oversaturation, accurate skin across diverse tones. The grade that makes the world look inviting and real.", duration: "22 min", type: "video",    free: false, skillsGained: ["Documentary grade", "Natural colour"] },
        { id: "cg-l10", title: "Fashion/Editorial Grade",                        description: "High fashion campaigns and editorial: precise skin tone rendering, intentional colour cast (often cool), high contrast with preserved highlight detail, minimal saturation in non-skin areas. The grade looks expensive.", duration: "25 min", type: "video",    free: false, skillsGained: ["Fashion grade", "Editorial look"] },
      ],
    },
    {
      id:          "cg-m3",
      ...
      lessons: [
        { id: "cg-l11", title: "HSL Qualification: Isolate Anything",          description: "Resolve's Qualifier tool lets you select a colour range (like skin, sky, or a specific object) and apply corrections only to those pixels. Learn the complete qualifier workflow: pick the colour, refine with Hue/Saturation/Luminance range, clean with the Matte tools.", duration: "30 min", type: "video",    free: false, skillsGained: ["HSL qualification", "Secondary correction"] },
    ...
    },
    {
      ...
      lessons: [
        { id: "cg-l21", title: "ACES: The Professional Colour Management Workflow", description: "ACES (Academy Color Encoding System) is the standard colour pipeline in Hollywood. Learn to configure Resolve's ACES settings for your camera, understand Input/Output Transforms, and why ACES produces more accurate results across multiple cameras on one project.", duration: "28 min", type: "video",    free: false, skillsGained: ["ACES workflow", "Professional colour management"] },
  ...
  modules: [
    {
      ...
      lessons: [
        { id: "me-l1",  title: "ProRAW and RAW: Why You Must Switch Today",    description: "Shoot in ProRAW on iPhone 12 Pro+ or Expert RAW on Android flagship phones. The editing range difference: JPEG can recover 1–1.5 stops of shadows; RAW can recover 4–5 stops. For any creative photo, RAW is non-negotiable. We show you exactly how to enable it.", duration: "12 min", type: "video",    free: true,  skillsGained: ["ProRAW setup", "RAW workflow"] },
        { id: "me-l2",  title: "Manual Controls: AE/AF Lock, Exposure Compensation, ProMode", description: "Tap to set focus. Tap and hold to lock focus AND exposure independently. Use the sun slider to set exposure manually. On Android, use ProMode for manual ISO, shutter speed, and focus. These simple controls put professional results in your hands.", duration: "14 min", type: "video",    free: false, skillsGained: ["Manual camera controls", "Exposure control"] },
        { id: "me-l3",  title: "Composition for Mobile: The 5 Rules That Work", description: "Rule of thirds via grid lines, leading lines that fill the narrow mobile frame, foreground elements for depth (hard to see on small screens — learn what works), vertical composition for social (1:1 and 4:5 ratios), and the eye-level magic of a wider prime lens perspective.", duration: "16 min", type: "video",    free: false, skillsGained: ["Mobile composition", "Social media framing"] },
        { id: "me-l4",  title: "Portrait Mode: Understanding and Overriding the AI",description: "Portrait Mode uses machine learning to create artificial bokeh. Understand its limitations (edges near fine hair, reflections, glass), how to manually adjust the depth slider after the shot, and which lighting effects (Natural, Studio, Contour, Stage) are actually useful vs. gimmicky.", duration: "12 min", type: "video",    free: false, skillsGained: ["Portrait Mode mastery", "Mobile bokeh"] },
    ...
    },
    {
      ...
      lessons: [
        { id: "me-l6",  title: "The Full Lightroom Mobile Interface Tour",      description: "Navigate every panel: Light (Exposure, Contrast, Highlights, Shadows, Whites, Blacks), Colour (White Balance, Vibrance, Saturation), Detail (Sharpening, Noise), Effects (Vignette, Grain), Optics (Lens Correction), and Geometry (Crop, Rotate). Know where everything lives before you need it.", duration: "18 min", type: "video",    free: false, skillsGained: ["Lightroom Mobile navigation", "Panel familiarity"] },
        { id: "me-l7",  title: "AI Tools: Masking, Select Subject, Select Sky", description: "Lightroom Mobile's AI masking changes everything. Select Subject isolates your main subject in 2 seconds. Select Sky isolates the sky automatically. Use these to apply completely different edits to subject vs. background — a 10-minute technique in Photoshop, now 10 seconds on your phone.", duration: "20 min", type: "video",    free: false, skillsGained: ["AI masking", "Selective editing mobile"] },
