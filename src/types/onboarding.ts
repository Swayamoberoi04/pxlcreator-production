...
export const PROFESSIONS = [
  ...
  { id: "cinematic-editor",      label: "Cinematic Editor",      icon: "◉",  color: "#ffd700" },
  ...
  { id: "filmmaker",             label: "Filmmaker",             icon: "◐",  color: "#ffd700" },
...
export const AESTHETICS = [
  ...
  { id: "dark-luxury",      label: "Dark Luxury",        gradient: "from-black via-gray-950 to-zinc-900",       accent: "#ffd700" },
