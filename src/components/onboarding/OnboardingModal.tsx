 ...
 *
 * Architecture:
 *   OnboardingGate (decides when to show)
 *     └─ OnboardingModal (renders the overlay)
 *         └─ Step components (1–5 + complete)
 */
...
export function OnboardingModal() {
  ...
  const dir = 1 // always forward for entrance; back button handles reverse
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(ellipse at 50% 0%, #ffd70060, transparent 70%)",
          }}
        />
        ...
        <motion.div
          ...
          className="relative z-10 w-full max-w-[640px] max-h-[90vh] flex flex-col
          ...
          <div className="px-6 pt-6 pb-4 shrink-0">
            ...
            {step < 6 && (
              <div className="flex items-center gap-2 mb-5">
                ...
                <span className="text-[0.75rem] text-muted/50 ml-1 shrink-0">
                  {step}/5
                </span>
              </div>
            )}
