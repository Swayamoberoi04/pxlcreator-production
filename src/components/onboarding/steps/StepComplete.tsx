...
export function StepComplete({ dna, sections, onClose }: Props) {
  ...
  return (
    <div className="flex flex-col items-center gap-8 py-2">
      ...
      >
        <div className="relative overflow-hidden rounded-2xl border border-gold/30 bg-gradient-to-br from-black via-zinc-950 to-black p-7 shadow-[0_0_60px_rgba(255,214,10,0.12)]">
          {/* Ambient glow */}
          <div
