...
const VARIANTS: Record<LuminousVariant, OrbDef[]> = {
  gold: [
    { pos: "15% 0%",    color: "rgba(255,215,0,0.13)",   size: "80% 45%",  anim: "lenv-breathe-a", delay: "0s"   },
    { pos: "85% 70%",   color: "rgba(229,162,39,0.09)",  size: "65% 55%",  anim: "lenv-breathe-b", delay: "1.8s" },
  ...
  indigo: [
    { pos: "80% 10%",   color: "rgba(99,102,241,0.12)",  size: "70% 50%",  anim: "lenv-breathe-b", delay: "0s"   },
    { pos: "10% 80%",   color: "rgba(139,92,246,0.10)",  size: "60% 55%",  anim: "lenv-breathe-a", delay: "2.1s" },
    { pos: "50% 30%",   color: "rgba(165,180,252,0.06)", size: "80% 40%",  anim: "lenv-breathe-b", delay: "1.0s" },
  ...
  store: [
    { pos: "70% 0%",    color: "rgba(255,215,0,0.11)",   size: "75% 45%",  anim: "lenv-breathe-a", delay: "0s"   },
    { pos: "5% 70%",    color: "rgba(99,102,241,0.10)",  size: "60% 55%",  anim: "lenv-breathe-b", delay: "1.5s" },
    { pos: "50% 100%",  color: "rgba(255,180,0,0.05)",   size: "110% 30%", anim: "lenv-breathe-b", delay: "2.8s" },
    { pos: "90% 60%",   color: "rgba(139,92,246,0.06)",  size: "40% 50%",  anim: "lenv-drift",     delay: "0.7s" },
    { pos: "30% 20%",   color: "rgba(255,215,0,0.05)",   size: "50% 40%",  anim: "lenv-breathe-a", delay: "3.5s" },
  ],
  preset: [
    { pos: "25% 0%",    color: "rgba(255,215,0,0.10)",   size: "85% 40%",  anim: "lenv-breathe-a", delay: "0s"   },
    { pos: "80% 60%",   color: "rgba(255,160,0,0.07)",   size: "55% 50%",  anim: "lenv-breathe-b", delay: "2.0s" },
    { pos: "0% 100%",   color: "rgba(229,162,39,0.05)",  size: "70% 35%",  anim: "lenv-breathe-a", delay: "1.4s" },
    { pos: "60% 40%",   color: "rgba(99,102,241,0.05)",  size: "50% 55%",  anim: "lenv-drift",     delay: "0.9s" },
  ],
  studio: [
    { pos: "85% 5%",    color: "rgba(99,102,241,0.13)",  size: "65% 50%",  anim: "lenv-breathe-b", delay: "0s"   },
    { pos: "10% 80%",   color: "rgba(165,180,252,0.09)", size: "60% 55%",  anim: "lenv-breathe-a", delay: "1.6s" },
    { pos: "50% 50%",   color: "rgba(255,215,0,0.06)",   size: "70% 40%",  anim: "lenv-breathe-b", delay: "2.4s" },
  ...
  vision: [
    ...
    { pos: "40% 100%",  color: "rgba(255,215,0,0.04)",   size: "80% 30%",  anim: "lenv-breathe-a", delay: "2.2s" },
  ],
  neutral: [
    { pos: "25% 0%",    color: "rgba(255,215,0,0.07)",   size: "70% 40%",  anim: "lenv-breathe-a", delay: "0s"   },
    { pos: "80% 80%",   color: "rgba(99,102,241,0.07)",  size: "55% 50%",  anim: "lenv-breathe-b", delay: "2.0s" },
