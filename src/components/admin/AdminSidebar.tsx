...
const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href:  "/admin/editor-presets",
    icon:  <EditorIcon />,
  },
  {
    label: "Editor Changelog",
    href:  "/admin/editor-changelog",
    icon:  <ChangelogIcon />,
  },
  {
    label: "SEO Manager",
...
function ChangelogIcon() {
  return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="9"/></svg>
}
...
function BIIcon() {
  return <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/><path d="M16.24 7.76A6 6 0 0 1 18 12"/></svg>
}
