        ...
        <div className="mx-auto max-w-xl">
          ...
          <CinematicReveal variant="depth">
            <div className="flex flex-col items-center text-center gap-5 mb-10">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-gold/10 border border-gold/25 shadow-[0_0_48px_rgba(255,215,0,0.18)]">
                <CheckCircleIcon />
              </div>
              <div>
...
function CheckCircleIcon() {
  return <svg width="38" height="38" viewBox="0 0 24 24" fill="none" stroke="#ffd700" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><polyline points="22 4 12 14.01 9 11.01"/></svg>
}
...
function PresetIcon() {
  return <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#ffd700" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>
}
